...
describe('test MonthPicker component', () => {
  ...
  it('render the correct year and month, show correcet dropdown status', () => {
  ...
  it('after click button, dropdown should show, year list&month should have the correct items', () => {
